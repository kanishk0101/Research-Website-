  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="container mx-auto px-4 py-16">
        {/* Book Chapter */}
        <div className="mb-16">
          <h2 className="font-heading text-3xl font-bold text-slate-900 mb-6 pb-2 border-b border-slate-200">
            Book Chapter
          </h2>
          <p className="text-slate-500 italic">No book chapters available at this time.</p>
        </div>
